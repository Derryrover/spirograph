...
var _Derryrover$spirograph$DevideTwoPiEqual$devide = function (samples) {
	var fraction = (2 * _elm_lang$core$Basics$pi) / _elm_lang$core$Basics$toFloat(samples);
	var listInt = A2(_elm_lang$core$List$range, 0, samples);
	return A2(
		_elm_lang$core$List$map,
		function (p) {
			return _elm_lang$core$Basics$toFloat(p) * fraction;
		},
		listInt);
};
...
var _Derryrover$spirograph$MainTypes$Back = {ctor: 'Back'};
var _Derryrover$spirograph$MainTypes$To = {ctor: 'To'};
...
var _Derryrover$spirograph$PortSendCoordinates$sendCoordinates2 = _elm_lang$core$Native_Platform.outgoingPort(
	'sendCoordinates2',
	function (v) {
		return _elm_lang$core$Native_List.toArray(v).map(
			function (v) {
...
var _Derryrover$spirograph$PortSendCoordinates$sendCoordinates3 = _elm_lang$core$Native_Platform.outgoingPort(
	'sendCoordinates3',
	function (v) {
		return _elm_lang$core$Native_List.toArray(v).map(
			function (v) {
...
var _Derryrover$spirograph$TimeIntervalCalculator$calc = function (_p0) {
	var _p1 = _p0;
	var _p4 = _p1.timeIntervals;
	var _p3 = _p1.currentTimeInterval;
	var _p2 = _p1.animationDirection;
...
var _Derryrover$spirograph$MainState$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _elm_lang$animation_frame$AnimationFrame$diffs(_Derryrover$spirograph$MainTypes$Frame),
			_1: {ctor: '[]'}
		});
};
...
var _Derryrover$spirograph$MainState$initialModel = {spirograph1: _Derryrover$spirograph$MainState$spirograph1, spirograph2: _Derryrover$spirograph$MainState$spirograph2, samples: 300, timingRecord: _Derryrover$spirograph$MainState$timingRecord};
	...
	_1: _elm_lang$core$Platform_Cmd$batch(
		{
			...
			_0: _Derryrover$spirograph$PortSendCoordinates$sendCoordinates1(
				A2(_Derryrover$spirograph$MainState$makeSpiro, _Derryrover$spirograph$MainState$initialModel.spirograph1, _Derryrover$spirograph$MainState$initialModel.samples)),
			_1: {
				ctor: '::',
				_0: _Derryrover$spirograph$PortSendCoordinates$sendCoordinates2(
					A2(_Derryrover$spirograph$MainState$makeSpiro, _Derryrover$spirograph$MainState$initialModel.spirograph2, _Derryrover$spirograph$MainState$initialModel.samples)),
				_1: {
					ctor: '::',
					_0: _Derryrover$spirograph$PortSendCoordinates$sendCoordinates3(
						A2(_Derryrover$spirograph$MainState$makeSpiro, _Derryrover$spirograph$MainState$initialModel.spirograph1, _Derryrover$spirograph$MainState$initialModel.samples)),
					_1: {ctor: '[]'}
				}
			}
...
var _Derryrover$spirograph$Main$main = _elm_lang$html$Html$program(
	{init: _Derryrover$spirograph$MainState$init, view: _Derryrover$spirograph$MainView$view, subscriptions: _Derryrover$spirograph$MainState$subscriptions, update: _Derryrover$spirograph$MainState$update})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _Derryrover$spirograph$Main$main !== 'undefined') {
    _Derryrover$spirograph$Main$main(Elm['Main'], 'Main', undefined);
}
